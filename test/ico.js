...
*/
    it("check calculateTokensAmount & minInvest & buyTokens & check ethers", async function () {
        ...
        console.log(new BigNumber(stats[0]).valueOf());
        console.log(new BigNumber(stats[1]).valueOf());
        console.log(new BigNumber(stats[2]).valueOf());
        console.log(new BigNumber(stats[3]).valueOf());
        console.log(new BigNumber(stats[4]).valueOf());
        console.log(new BigNumber(stats[5]).valueOf());
        console.log(new BigNumber(stats[6]).valueOf());
        console.log(stats[7]);
        // console.log(stats[8]);
        // console.log(new BigNumber(stats[9]).valueOf());
        // console.log(new BigNumber(stats[10]).valueOf());
        // console.log(new BigNumber(stats[11]).valueOf());


        //1 token = 1 ether * etherInUsd / tier.price
        //10 ^ 18 * 119493000 / 8000 = 14936625000000000000000
        console.log(new BigNumber(await ico.testCalculateTokensAmount.call(
